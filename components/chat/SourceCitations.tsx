      ...
      <div className="mt-3 space-y-2">
        {sources.map((source) => (
          <div
            ...
            className="rounded-2xl border border-white/80 bg-white/90 px-3 py-2 shadow-sm"
          >
            <div className="flex items-start gap-2">
              ...
              <div className="min-w-0">
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <span className="rounded-full bg-sky-50 px-2 py-0.5 text-[10px] font-medium uppercase tracking-[0.2em] text-sky-600">
                    {source.category}
                  </span>
                </div>
