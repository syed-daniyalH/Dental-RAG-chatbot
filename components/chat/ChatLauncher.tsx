...
export function ChatLauncher({ onClick, className }: ChatLauncherProps) {
  return (
    ...
    >
      ...
      <span className="hidden min-w-0 flex-col gap-0.5 text-left md:flex">
      ...
      <ArrowUpRight className="hidden h-4 w-4 text-slate-400 transition-transform group-hover:-translate-y-0.5 group-hover:translate-x-0.5 md:block" />
